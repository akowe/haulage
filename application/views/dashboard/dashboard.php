			...
			<div class="col-xs-12">
				<div class="container">
					<div class="rounded" style="background: var(--brighter-blue); margin-top: -20px; ">
						...
						<div class="col-12">
							<a class=" float-right btn  mx-2 my-2 border-0  text-white"
							   style="border-color: transparent; background-color: var(--modified-orange); font-size: 1.3rem"
							   href="<?php echo site_url().'add_booking'?> "
							>
								Book
							</a>
					...
					<div class="bg-light  rounded table-responsive dataTable">
						...
						<div class="col-12 ">
							<div class="mb-3 py-2 w-100">
								<h4  class=""
									 style="color: var(--modified-text-color)">Recent Transactions</h4 >
							...
							<table class="table table-striped" id="dataTable">
								...
								foreach ($b->result() as $row) {
									...
									<tr>
										...
										<td class="small" >
											<?php
											echo "<a title='View Invoice' style='cursor:pointer' class='text-primary' href=".site_url()."invoice?id=".$row->id."  >Invoice</a>";?>
