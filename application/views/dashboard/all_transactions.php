			...
			<nav class="navbar navbar-expand-lg navbar-light ">
				<div class="container-fluid">
					...
					<a class="navbar-brand font-weight-bold flex-grow-1" style="font-size: 30px; color: var(--heading-text-color);"
					   href="javascript:void(0)">&nbsp; All Transaction</a>
							...
							<table class="table table-striped" id="dataTable">
								...
								foreach ($b->result() as $row) {
									...
									<tr>
										...
										<td class="small" style="color:var(--modified-orange); font-weight: 600;">
											<?php echo $row->invoice_status;?>

											<?php
											echo "<a class='btn btn-sm text-white' href=".site_url()."paid?id=".$row->id."  >
										<span class='text-primary'>Confirm Payment</span> 
										</a>";?>
